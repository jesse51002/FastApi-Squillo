...
class ClaudeService(BaseLLMService):
    ...
    async def call_llm_api(
        ...
        request_data = {
            ...
            "max_tokens": 10000,
            "temperature": 0,
            "messages": [ClaudeMessage(role="user", content=input_prompt)],
        }
        ...
        if json_schema:
            ...
            request_data["tool_choice"] = ClaudeToolChoice(
                type="tool", name="provide_json_response"
            )
        ...
        headers_model = ClaudeHeaders(x_api_key=self.api_key)
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    if claude_response.content:
                        ...
                        if (
                            json_schema
                            and claude_response.content[0].type == "tool_use"
                        ):
